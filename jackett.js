...
function changeParser() {
     ...
     if (Lampa.Storage.get('jackett_urltwo') == 'prisma') 		Lampa.Storage.set('jackett_url', 'api.prisma.ws:443')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview', 'all')&Lampa.Storage.set('parse_in_search', true)&Lampa.Storage.set('parse_lang', 'lg');
