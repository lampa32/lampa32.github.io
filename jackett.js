...
function myRequest(i) {
    ...
    $(mySelector).html('<span style="color: green;">&#10004;</span>&nbsp;&nbsp;<span style="background-color: #308446; padding: 5px 2px; border: 1px solid green; border-radius: 20px; -webkit-backface-visibility: hidden; backface-visibility: hidden;">' + $(mySelector).text() + '</span>');
}
		   } else {
	               if ($(mySelector).text() == parserName[i]) $(mySelector).html('&#10008;&nbsp;&nbsp;' + $(mySelector).text()).css('color', 'ff0000');
                   }
