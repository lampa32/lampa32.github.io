...
function myRequest(i) {
    ...
    $(mySelector).html('<span style="color: green;">&#10004;</span>&nbsp;&nbsp;<span style="background-color: #1aff00; padding: 2px 5px; border: 1px solid green; border-radius: 10px;">' + $(mySelector).text() + '</span>');
		       }
		   } else {
	               if ($(mySelector).text() == parserName[i]) $(mySelector).html('&#10008;&nbsp;&nbsp;' + $(mySelector).text()).css('color', 'ff0000');
                   }
