...
function myRequest(i){
			setTimeout(function(){
				...
				var k = i + 2; 
				if (parserBase[i] == 'api.prisma.ws:443') proto = 'https://' else proto = 'http://'
...
function changeParser() {
     ...
     if (Lampa.Storage.get('jackett_urltwo') == 'prisma') 		Lampa.Storage.set('jackett_url', 'https://api.prisma.ws:443')&Lampa.Storage.set('jackett_key', '')&Lampa.Storage.set('jackett_interview', 'all')&Lampa.Storage.set('parse_in_search', true)&Lampa.Storage.set('parse_lang', 'lg');
