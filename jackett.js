    ...
    onRender: function (item) {
		//changeParser();
			setTimeout(function() {
				...
				if(Lampa.Storage.field('parser_use')) item.show()&$('.settings-param__name', item).css('color','000000')&$('div[data-name="jackett_url_two"]').insertAfter('div[data-children="parser"]');
				else item.hide();
			}, 20);
        }
   });
