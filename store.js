(function () {
    ...
    Lampa.Settings.listener.follow('open', function (e) {
        if (e.name == 'interface') {
            var interfaceComponent = Lampa.Settings.main().render().find('[data-component="interface"]');
            interfaceComponent.find('[data-component="pirate_store"]').on('hover:enter', function () {
