...
function myRequest(i) {
	...
	setTimeout(function() {
		var myLink = 'http://' + options[i] + ':9118' + '/ts';
...
/* Функция для отображения кнопки смены сервера в верхнем баре */
 ...
 function switch_server() {
	...
	$('#SWITCH_SERVER').on('hover:enter hover:click hover:touch', function() {
		...
		Lampa.Storage.set('torrserver_url_two', 'http://' + searchRandom() + ':9118' + '/ts');
		...
		if (localStorage.getItem('torrserv') === null || localStorage.getItem('torrserv') == 1) {
		   Lampa.Storage.set('torrserver_url_two', ''); // обнуляем доп. ссылку  
			 ...
			 Lampa.Storage.set('torrserver_use_link', 'two');
			   ...
			   if (myResult !== 'undefined') Lampa.Storage.set('torrserver_url_two', 'http://' + myResult + ':9118' + '/ts');
