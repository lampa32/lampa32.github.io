...
function showLoadingBar() {
  ...
  loadingBar.style.right = '0'; // Начинаем с правого края экрана
  ...
  loadingIndicator.style.right = '0'; // Начинаем с правого края
  ...
  // Запускаем анимацию
  setTimeout(function() {
    loadingIndicator.style.width = '100%'; // Движение справа налево
  }, 500);
