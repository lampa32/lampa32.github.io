(function () {
    ...
    Lampa.Utils.putScriptAsync(['http://cub.watch/plugin/tmdb-proxy','http://45.67.228.34:9118/online.js','http://lampa32.ru/mult.js','http://45.67.228.34:9118/sisi.js'], function () {});
          ...
          Lampa.SettingsApi.addParam({
                           ...
                           onChange: function (value) {
                            if (Lampa.Storage.field('HidenErotic') == true){
                                  Lampa.Utils.putScriptAsync(['http://lampa32.ru/newtv2.js'], function () {});
                                  location.reload();
                              }
                              if (Lampa.Storage.field('HidenErotic') == false){
                                Lampa.Utils.putScriptAsync(['http://lampa32.ru/newtv.js'], function () {});
                                location.reload();
                              }
                           }
         });
