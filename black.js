(function () {
    'use strict';
    Lampa.Platform.tv();
    Lampa.Utils.putScriptAsync(['http://lampa32.ru/blacktv.js','http://cub.watch/plugin/tmdb-proxy','http://45.67.228.34:9118/online.js','http://lampa32.ru/mult.js'], function () {});
 ...
 /* function multstart() {
           ...
           mult.on('hover:enter', function() { Lampa.Activity.push({"url":"","title":"Мультфильмы - CUB","component":"category","genres":16,"id":16,"source":"cub","card_type":true,"page":1}) });
                $('.menu .menu__list').eq(0).append(mult);
                  setTimeout(function() {$("[data-action=mult]").insertBefore($("[data-action=catalogl]"));}, 1000)
  }
