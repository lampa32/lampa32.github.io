(function () {
    ...
    Lampa.Utils.putScriptAsync(['http://cub.watch/plugin/tmdb-proxy','http://45.67.228.34:9118/online.js','http://45.67.228.34:9118/sisi.js'], function () {});
...
Lampa.Settings.listener.follow('open', function (e) { 
 if (e.name == 'main') {
   setTimeout(function() {
	...
	/*Ставим Cub источником по умолчанию*/
  ...
  Lampa.Listener.follow('app', function (e) {
	...
	/*Заменяем иконки и названия в пунктах Онлайн и Трейлеры*/
          ...
          Lampa.SettingsApi.addParam({
                           ...
                           onChange: function (value) {
                            if (Lampa.Storage.field('HidenErotic') == true){
                                  Lampa.Utils.putScriptAsync(['http://45.67.228.34/newtv2.js'], function () {});
                                  location.reload();
                              }
                              if (Lampa.Storage.field('HidenErotic') == false){
                                Lampa.Utils.putScriptAsync(['http://45.67.228.34/newtv.js'], function () {});
                                location.reload();
                              }
                           }
         });
