  ...
  startPlugin = function () {
    ...
    Lampa.Listener.follow("full", function (e) {
      if (e.type == "complite") {
        ...
        .td{display:table-cell;border-bottom:2.5px solid rgba(255,255,255,.1);color:rgba(255,255,255);padding:8 10px;font-size: 12px;}.collection{display:table;width:90%}.collectionfocus{}.collectionfocus.focus{outline:outset #FFF}.rating{text-align:center;width:4em}.year{width:8em;text-align:right}.title{text-align:left;width:10em}.num{text-align:center;width:3em}
